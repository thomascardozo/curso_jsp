		...
		<table class="responsive-table">
			...
			<c:forEach items="${telefone}" var="fone">
				<tr>
					...
					<td><a href="salvarTelefones?user=${fone.usuario}&acao=deleteFone&foneId=${fone.id}"><img src="resources/img/icon.png" alt="Excluir" title="Excluir" onclick="return confirm('Confirma a exclusão?')" width="32px" height="32px" /></a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
