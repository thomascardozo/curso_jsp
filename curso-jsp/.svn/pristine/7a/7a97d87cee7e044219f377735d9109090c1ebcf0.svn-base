				...
				<table>
					<tr>
						...
						<td><input type="text" readonly="readonly" id="id" name="id"
							value="${produto.id}" class="field-long" style="width: 173px"></td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" id="quantidade" name="quantidade"
							data-thousands="." value="${produto.quantidade}" maxlength="7"></td>
					</tr>
			...
			<c:forEach items="${produtos}" var="produto">
				<tr>
					...
					<td><a href="salvarProduto?acao=delete&produto=${produto.id}"><img
							...
							onclick="return confirm('Confirma a exclusão?')" width="20px"
							height="20px"> </a></td>
